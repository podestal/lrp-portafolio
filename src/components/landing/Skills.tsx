...
const Skills = () => {
  ...
  return (
    <div className="max-w-full min-h-screen lg:min-h-[160vh] text-center flex flex-col justify-center items-center gap-20 my-10 mx-auto">
        <motion.h2 
